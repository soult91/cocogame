...
public class DressKinect2 : MonoBehaviour {
			...
			if (manager.IsUserDetected ()) {
				...
				if (manager.IsJointTracked (userId, iJointIndex) && manager.IsJointTracked (userId, iJointIndex1)) {
					...
					if (posJoint != Vector3.zero) {
						...
						float distancia1X = object1X - jointX1;
						float distancia1Y = object1Y - jointY1;
						...
						if (listClicked.Count < 7) {
							...
							if (distanciaY < 0.1 && distanciaY > -0.1 && distanciaX < 0.8 && distanciaX > 0.7) {
							...
							if (distancia1Y < 0.8 && distancia1Y > 0.6 && distancia1X < 3.5 && distancia1X > 3.4) {
							...
							if (distancia2Y < 1.42 && distancia2Y > 1.3 && distancia2X < -0.2 && distancia2X > -0.45) {

								Object2.transform.GetChild(0).Rotate (0, 0, 60);
							...
							if (distancia3Y < 0.22 && distancia3Y > 0.1 && distancia3X < 3.29 && distancia3X > 3.21) {

								Object3.transform.GetChild(0).Rotate (0, 60, 0);
							...
							if (distancia4Y < 0.7 && distancia4Y > 0.59 && distancia4X < 3.64 && distancia4X > 3.5) {
							...
							if (distancia5Y < 2.1 && distancia5Y > 1.9 && distancia5X < 1.61 && distancia5X > 1.55) {
