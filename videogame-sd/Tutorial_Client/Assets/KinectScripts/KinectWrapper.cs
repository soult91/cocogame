...
//    }
	...
	public static int GetSkeletonJointParent(int jointIndex)
	{
		switch(jointIndex)
		{
			...
			case (int)NuiSkeletonPositionIndex.FingersLeft:
				return (int)NuiSkeletonPositionIndex.FingersLeft;
			case (int)NuiSkeletonPositionIndex.PisiformLeft:
				return (int)NuiSkeletonPositionIndex.PisiformLeft;
			case (int)NuiSkeletonPositionIndex.ThumbLeft:
				return (int)NuiSkeletonPositionIndex.ThumbLeft;
			case (int)NuiSkeletonPositionIndex.FingersRight:
				return (int)NuiSkeletonPositionIndex.FingersRight;
			case (int)NuiSkeletonPositionIndex.PisiformRight:
				return (int)NuiSkeletonPositionIndex.PisiformRight;
	...
	public static bool PollDepth(IntPtr depthStreamHandle, bool isNearMode, ref ushort[] depthPlayerData)
	{
		...
		if (hr == 0)
		{
			...
			DepthBuffer deb = (DepthBuffer)Marshal.PtrToStructure(lockedRectPtr.pBits, typeof(DepthBuffer));
			depthPlayerData = deb.pixels;
