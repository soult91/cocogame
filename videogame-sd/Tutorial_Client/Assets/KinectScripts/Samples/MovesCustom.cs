...
public class MovesCustom : MonoBehaviour 
{
...
//						Vector3 vPosOverlay = backgroundImage.transform.TransformPoint(localPos);
						...
						if(Object0)
						{
							...
							Object0.transform.position = Vector3.Lerp(Object0.transform.position, vPosOverlay, smoothFactor * Time.deltaTime);
                            Debug.Log(Object0.transform.position);
						}
					}
				}
