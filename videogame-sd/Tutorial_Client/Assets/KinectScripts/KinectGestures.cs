...
public class KinectGestures : MonoBehaviour
{
	...
	private const int leftFingersIndex = (int)KinectWrapper.NuiSkeletonPositionIndex.FingersLeft;

	private const int rightHandIndex = (int)KinectWrapper.NuiSkeletonPositionIndex.HandRight;
	private const int rightFingersIndex = (int)KinectWrapper.NuiSkeletonPositionIndex.FingersRight;
